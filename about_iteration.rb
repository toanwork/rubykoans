...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # - Provide an accumulator variable with an initial value
    # - After each iteration, update the accumulator with the value returned from the given block
    # - After iteration is finished, return the value of the accumulator
  end
