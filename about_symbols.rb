...
class AboutSymbols < Neo::Koan
  ...
  # Answer:
  #
  # `Symbol.all_symbols.include?(:myName)` always return `true`
  # because when we define `:myName` symbol, it will be included in the list of symbols
  # before `include?` method is called.
  # So we have to convert the list of symbols to strings first then compare against the string value.
